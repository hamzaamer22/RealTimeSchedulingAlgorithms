...
class RunProcesses:
    ...
    def check_min_deadline(self):
        ...
        for i in range(self.processes):
            if self.start_deadline[i] < min_deadline and self.available[i]:
                min_deadline = self.start_deadline[i]
                process = i
        return process
...
if __name__ == '__main__':
    print("Using Rate Monotonic First Algorithm")
    # processes = 4
    ...
    window = Tk()
    window.title("Rate Monotonic Algorithm")
    ...
    head_label = Label(window, text="Rate Monotonic Algorithm", font=("Arial", 20, "bold"), fg="#36454F")
